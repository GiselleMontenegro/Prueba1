...
function step()
	...
	-- Checks if there are objects that can be sensed by the proximity sensor
	obstacle = false
	for i=1,4 do
	...
	-- Process the information obtained, if existent
	...
	-- Commands a propper velocity command for the wheels
	if(not avoid_obstacle) then
